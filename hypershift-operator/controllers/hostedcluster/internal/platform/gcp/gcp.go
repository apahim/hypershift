...
func buildGCPWorkloadIdentityCredentials(wif hyperv1.GCPWorkloadIdentityConfig) (string, error) {
	...
	credConfig := gcpExternalAccountCredential{
		...
		ServiceAccountImpersonationURL: fmt.Sprintf("https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/%s:generateAccessToken", wif.ServiceAccountsRef.NodePoolEmail),
